...
public class StepDefination {
	...
	public void i_should_see_some_restaurants_in(String givenPostCode) {
		...
		String searchPostCode = wait.until(ExpectedConditions.visibilityOfElementLocated((By.xpath("(//*[@class=\"c-locationHeader-title\"])[1]")))).getText();
		...
		String numberOfRestaurants = wait.until(ExpectedConditions.visibilityOfElementLocated((By.xpath("//*[@data-search-count=\"openrestaurants\"]")))).getText();
